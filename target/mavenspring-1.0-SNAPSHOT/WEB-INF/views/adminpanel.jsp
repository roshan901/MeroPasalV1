...
<head>
  ...
  <title>MeroPasal Admin - Dashboard</title>
...
<%--<jsp:include page ="sidebar.jsp"/> --%>
  ...
  <!-- Page level plugins -->
  <script src="${pageContext.request.contextPath}/static/backend/vendor/chart.js/Chart.min.js"></script>

  <!-- Page level custom scripts -->
  <script src="${pageContext.request.contextPath}/static/backend/js/demo/chart-area-demo.js"></script>
  <script src="${pageContext.request.contextPath}/static/backend/js/demo/chart-pie-demo.js"></script>
