...
<!--page content row -->
          <div class="row">
              <div class="col-lg-9">
                  <div class="card">
                      <div class="card-header bg-info"> Add new Category
                  </div>
                      <div class="card-body">
                          <form action="${pageContext.request.contextPath}/admin/category/add" method="post">
                              <div class="form-group">
                                  ...
                                  <input class="form-control" id ="catName" name="cat_name" placeholder="Enter category name">
                               </div>
                              <div class="form-group">
                                  <label for="catDesc"> Enter category description:</label>
                                  <input class="form-control" id="catDesc" name="cat_desc" placeholder="Enter category description">
                              </div>
                              <div class="form-group">
                                  <label for="catParent"> Enter category Parent:</label>
                                  <select class="form-control" id="catParent" name="cat_parent">
  ...
  <script src="<c:url value="${pageContext.request.contextPath}/static/vendor/bootstrap/js/bootstrap.bundle.min.js"/>"</script>
